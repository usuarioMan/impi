...
class BusquedaSimple(Busqueda):
    def busqueda(self):
        ...
        element = self.driver.find_element_by_link_text("Búsqueda simple")
        element.click()
        input_a = self.driver.find_element_by_id("busquedaSimpleForm:cadenaBusquedaText")
        input_b = self.driver.find_element_by_id("busquedaSimpleForm:seccion:1")
        input_c = self.driver.find_element_by_id("busquedaSimpleForm:opciones3:2")
        input_d = self.driver.find_element_by_id("busquedaSimpleForm:buscar")
